        ...
        <div className="max-w-7xl mx-auto px-4 py-12 md:py-16 pt-32 md:pt-40">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              Participe do nosso sorteio e ganhe 2 <a href="https://www.lojastemperare.com.br/produto/liquidificador-blender-1450w-2-litros-alta-rotacao-com-temporizador-75441" target="blank" className="text-color-">Blender Profissionais de 1450w com 2 litros de capacidade e com temporizador.</a>
            </p>
          </div>
